...
RUN apt-get -y install libapache2-mod-php5 php5-cli php5-mysql php5-gd php5-mcrypt \
...
# Ejecutar siempre al arrancar el script "do.sh" que a su vez ejecutará el comando de la última línea
#
ADD do.sh /do.sh
RUN chmod +x /do.sh
ENTRYPOINT ["/do.sh"]
